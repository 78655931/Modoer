...
class task_item_picture {

    var $flag = 'item:picture';
    var $title = 'item_task_picture_title';
    ...
    function form_post($cfg) { 
        if(!$cfg['num'] || !is_numeric($cfg['num']) || $cfg['num'] < 1) redirect('完成条件错误：未填写一个有效的图片上传数量。');
