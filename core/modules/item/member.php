...
$allowacs = array('m_subject', 'm_review', 'm_picture', 'm_guestbook', 'm_respond', 'subject_add', 
'subject_edit', 'subject_apply', 'review_add', 'review_edit', 'g_subject', 'g_review', 
'g_guestbook', 'g_picture', 'favorite', 'pic_upload', 'impress','g_album','setting','style','discussion');
