...
// 标识，唯一值
$newmodule['flag'] = 'discussion';
// 名称
$newmodule['name'] = '讨论组';
// 依赖,建立于某够模块之上,核心模块除外，这里写其他模块的标识
$newmodule['reliant'] = '';
// 介绍
$newmodule['introduce'] = '用于主题内的讨论话题交流';
// 作者
...
// 发布事件
$newmodule['releasetime'] = '2012-3-10';
// 版本检测 返回一个最新版本号，用于比较当前的版本
$newmodule['checkurl'] = 'http://www.modoer.com/info/module/discussion.php';
// 是否支持多城市
